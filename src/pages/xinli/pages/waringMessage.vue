<template>
    <div class="content">
        ...
        <el-tabs v-model="personnelType" type="card" @tab-click="handleClick">
            <el-tab-pane label="重度心理异常人员报警通知" name="first">
            ...
            <el-tab-pane label="轻度心理异常人员报警通知" name="second">
                <div class="tableBorder">
                    ...
                    <hr class="boundary">
                    <!--表格-->
                    <info-table :messageList="messageList" :curPath="curPath" :personnelType="personnelType"
                                @getHandleId="showHandleDialog"></info-table>
                    <!--分页-->
                    <nav class="block">
                        <el-pagination layout="prev, pager, next"
